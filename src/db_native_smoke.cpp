...
constexpr char MODULE_INIT_SYMBOL[] = "PyInit__db_debug";
constexpr char MODULE_NAME[] = "_db_debug.pyd";
...
int main()
{
    ...
    FreeLibrary(module);
    std::puts("{\"event\":\"db_native_smoke\",\"status\":\"pass\"}");
    return EXIT_SUCCESS;
}
