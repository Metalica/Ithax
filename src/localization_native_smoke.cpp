...
constexpr char MODULE_INIT_SYMBOL[] = "PyInit__evelocalization_debug";
constexpr char MODULE_NAME[] = "_evelocalization_debug.pyd";
...
int main()
{
    ...
    {
        std::fprintf(stderr,
                     "{\"event\":\"localization_native_smoke\","
                     "\"status\":\"fail\","
    ...
    FreeLibrary(module);
    std::puts(
        "{\"event\":\"localization_native_smoke\",\"status\":\"pass\"}");
    return EXIT_SUCCESS;
}
