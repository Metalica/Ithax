...
constexpr char MODULE_INIT_SYMBOL[] = "PyInit__geo2_debug";
constexpr char MODULE_NAME[] = "_geo2_debug.pyd";
...
int main()
{
    ...
    FreeLibrary(module);
    std::puts("{\"event\":\"geo2_native_smoke\",\"status\":\"pass\"}");
    return EXIT_SUCCESS;
}
